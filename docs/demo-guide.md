...
This guide explains how to present the public HELPER showcase.

## Public Showcase Walkthrough

1. Open `README.md` and read the honest status block.
2. Open `docs/status-definitions.md` to explain what the current status terms mean publicly.
3. Review the hero screenshot and the generated artifact screenshots in `media/`.
4. Open `docs/one-pager.md` for the short positioning summary.
...
- The screenshots are presented as captured local demo evidence, and the proof-boundary note explains what the public repo can and cannot independently verify.
