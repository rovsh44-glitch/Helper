...
public sealed class BlueprintContractValidator : IBlueprintContractValidator
{
        ...
        List<string> warnings)
    {
        ...
        if (methods.Count == 0 && file.Role != FileRole.Interface)
        {
            ...
            methods = new List<ArbanMethodTask>
            {
                new("Execute", "public void Execute()", "Default execution entry point", string.Empty)
            };
        }
